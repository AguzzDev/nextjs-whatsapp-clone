...
export function NavUser() {
    return (
        <>
            <div className="flex flex-row justify-between items-center py-2 px-5 bg-gray3 select-none my-auto">
                <div>
                    <DrawerPerfilNavUser />
                </div>
                <div className="flex flex-row space-x-5 items-center mt-2">
